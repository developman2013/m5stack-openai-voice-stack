...
export HA_MCP_ENABLED="$(bashio::config 'ha_mcp_enabled')"
export HA_MCP_URL="$(bashio::config 'ha_mcp_url')"
export CONTINUOUS_CONVERSATION="$(bashio::config 'continuous_conversation')"
export SESSION_IDLE_SECONDS="$(bashio::config 'session_idle_seconds')"
